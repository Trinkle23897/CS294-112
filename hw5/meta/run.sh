...
# problem 3
python3 train_policy.py 'pm' --exp_name q3_rnn_50 --history 50 --discount 0.90 -lr 5e-4 -n 60 --generalized --granularity 1
python3 train_policy.py 'pm' --exp_name q3_rnn_50 --history 50 --discount 0.90 -lr 5e-4 -n 60 --generalized --granularity 2
python3 train_policy.py 'pm' --exp_name q3_rnn_50 --history 50 --discount 0.90 -lr 5e-4 -n 60 --generalized --granularity 4
python3 train_policy.py 'pm' --exp_name q3_rnn_50 --history 50 --discount 0.90 -lr 5e-4 -n 60 --generalized --granularity 5
python3 train_policy.py 'pm' --exp_name q3_rnn_50 --history 50 --discount 0.90 -lr 5e-4 -n 60 --generalized --granularity 10